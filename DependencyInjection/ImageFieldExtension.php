...
namespace SymfonyContrib\Bundle\ImageFieldBundle\DependencyInjection;
 ...
 */
class ImageFieldExtension extends Extension implements PrependExtensionInterface
{
    /**
     * @var string Template file for the confirm form.
     */
    public $formTemplate = 'ImageFieldBundle:Form:imagefield.html.twig';
